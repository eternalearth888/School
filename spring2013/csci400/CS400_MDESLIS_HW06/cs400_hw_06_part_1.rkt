...
; It's important to understand the difference between 'let' and 'let*'. 
...
; The lexical environment for any given piece of code consists of any
...
(define (jj1 c x)
  (display "jj1 jack-jill-jack-jill\n")
  (display "jack: ")(display (jack c x))(display "\n")
  (display "jill: ")(display (jill c x))(display "\n")
  (display "jack: ")(display (jack c x))(display "\n")
  (display "jill: ")(display (jill c x))(display "\n")
  (restore)
  (display "jj1 jack-jill-jill-jack\n")
  (display "jack: ")(display (jack c x))(display "\n")
  (display "jill: ")(display (jill c x))(display "\n")
  (display "jill: ")(display (jill c x))(display "\n")
  (display "jack: ")(display (jack c x))(display "\n")
...
(define (jjaa1 c x)
  (display "\njjaa1 results:\n")
        (display "adam: ") (display (adam c x)) (display "\n")
        (display "abby: ") (display (abby c x)) (display "\n")
        (display "adam: ") (display (adam c x)) (display "\n")
        (display "abby: ") (display (abby c x)) (display "\n")
...
; CALL   a    b    d    e    c    x    returns
; adam   3    5    15   5    7    2    29
; abby   3    5    15   3    7    2    27
; adam   3    5    25   3    7    2    37
; abby   3    5    25   15   7    2    49
; jack   15   5    25   15   7    2    29
; jill   15   3    25   15   7    2    27
; adam   15   3    47   15   7    2    71
; abby   15   3    47   25   7    2    81
; jack   25   3    47   25   7    2    37
; jill   25   15   47   25   7    2    49
; adam   25   15   79   25   7    2    113
; abby   25   15   79   47   7    2    135
; jack   47   15   79   47   7    2    71
; jill   47   25   79   47   7    2    81
